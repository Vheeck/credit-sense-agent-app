              ...
              <Block flex style={styles.profileCard}>
                ...
                <Block style={styles.info}>
                  ...
                  <Block row space="between">
                    <Block middle>
                      ...
                      <Text size={11} color={argonTheme.COLORS.TEXT}>Groups</Text>
                    </Block>
                    <Block middle>
                      <Text
                        bold
                ...
                <Block flex>
                  ...
                  <Block middle style={styles.nameInfo}>
                    ...
                    <Text size={16} color="#32325D" style={{ marginTop: 10 }}>
                    Phone: 090 234 456 2345
                    </Text>
                    <Text size={16} color="#32325D" style={{ marginTop: 10 }}>
                    Home Address: Group Supervisor Home Address
                      </Text>
                      <Text size={16} color="#32325D" style={{ marginTop: 10 }}>
                      Office Address: Group Supervisor Office Address
                      </Text>
